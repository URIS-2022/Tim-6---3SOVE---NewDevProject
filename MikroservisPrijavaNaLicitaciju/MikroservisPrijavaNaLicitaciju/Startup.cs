...
namespace MikroservisPrijavaNaLicitaciju
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IPrijavaNaLicitaciju, PrijavaNaLicitacijuRepository>();
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "Prijava na licitaciju Api",
                    Version = "v1",
                    Description = "An API to perform application for bidding operations",
