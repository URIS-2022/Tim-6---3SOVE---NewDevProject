...
namespace DokumentMicroservice.Migrations
{
    ...
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Oglas",
                columns: new[] { "DokumentId", "OglasId", "BrNadmetanjaJmbg", "BrNadmetanjaMaticniBrojPreduzeca" },
                values: new object[,]
                {
                    { new Guid("9a2d9ea6-d264-494a-88f8-51808a1c3196"), new Guid("011c616c-14db-4bc3-a9c9-c2f642b22f73"), "2906000855008", "24905678" },
                    { new Guid("9e2474b3-caf5-4123-944d-11b4ab186b6b"), new Guid("9151a095-2890-49c8-a3ac-f5813b92ffac"), "2906000855002", "23905678" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d762b24f-2730-427f-9789-3d840a5f7e39"), new Guid("b708754f-b5e9-481b-8898-ca3682107e9c"), new DateTime(2023, 2, 16, 13, 30, 51, 934, DateTimeKind.Local).AddTicks(6561), "PSPG-5/2022" },
                    { new Guid("e4be32f2-da5e-47d5-9fbf-b860eb1d79b3"), new Guid("4ff44338-8d0b-415a-8b44-dfce3d4c311d"), new DateTime(2023, 2, 16, 13, 30, 51, 934, DateTimeKind.Local).AddTicks(6551), "PSPG-1/2022" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("418af1d2-483f-4461-8d82-31b257527a4f"), new Guid("e3eab479-b0aa-4161-bbc9-d2281f43f332"), new DateTime(2023, 2, 16, 13, 30, 51, 934, DateTimeKind.Local).AddTicks(6611), "Luka", "PredDraganDraganovic", "Markovic", "PSPG-9/2022" },
                    { new Guid("c8e97d45-4bfc-4dca-ba07-20d1e93049d6"), new Guid("22b74319-edb5-4945-b792-76d0b1b81d88"), new DateTime(2023, 2, 16, 13, 30, 51, 934, DateTimeKind.Local).AddTicks(6601), "Marko", "PredPetarPetrovic", "Markovic", "PSPG-2/2022" }
                });
